...
from app.services.ai.clothing_detection import clothing_detection_service
...
async def process_wardrobe_image(
    ...
    try:
        ...
        try:
            ...
            logger.error(f"Failed to update status to 'failed' for item {item_id}: {str(update_error)}")
