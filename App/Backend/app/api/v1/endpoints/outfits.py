...
from app.crud.outfit import outfit_crud
from app.crud.wardrobe import wardrobe_crud
from app.models.user import User
from app.schemas.outfit import OutfitCreate, OutfitFeedback, OutfitList, OutfitResponse, OutfitWear
...
async def submit_outfit_feedback(
    ...
    logger.info(f"Feedback {feedback.feedback_score} submitted for outfit {outfit_id} by user {current_user.id}")
