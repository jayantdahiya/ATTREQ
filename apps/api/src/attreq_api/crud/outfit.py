...
class OutfitCRUD:
    ...
    async def get_by_id(
        ...
        if load_items:
            query = query.options(selectinload(Outfit.top_item), selectinload(Outfit.bottom_item))
    ...
    async def update_feedback(
        self, db: AsyncSession, outfit_id: UUID, feedback_score: int
    ) -> Outfit | None:
    ...
    async def mark_as_worn(
        self, db: AsyncSession, outfit_id: UUID, worn_date: date_type | None = None
    ) -> Outfit | None:
    ...
    async def delete(self, db: AsyncSession, outfit_id: UUID, user_id: UUID) -> bool:
        """Delete an outfit.
